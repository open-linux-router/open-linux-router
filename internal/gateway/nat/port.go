...
//
// This is the test behind docs/port-forwarding.md §5.1's refusal: two forwards on the
...
// and never read back, and `olr gateway` is a client of its own module's API.
