...
import type { AssignmentStatus, ExitStatus, GatewayTraffic, Usage } from '@/lib/api-types'
import type { Exit, GatewayConfig } from '@/lib/config-types'
...
export function GatewayPage() {
   ...
   */
  const change = (c: GatewayChange) => applier.submit(c)
        ...
        <CardHeader>
          ...
          <CardAction>
            <Switch
              ...
              disabled={applier.busy}
              onCheckedChange={(stats) => change(gatewayChange.settings({ stats }))}
            />
          </CardAction>
        </CardHeader>
        <CardContent>
